...
SimpleForm.setup do |config|
  ...
  # Prepend input
  config.wrappers :input_group_flat, tag: "div", class: "form-group", error_class: "form-group-invalid" do |b|
    b.use :html5
    b.use :placeholder
    b.optional :maxlength
    b.optional :minlength
    ...
    b.optional :readonly
    b.use :label, class: "form-label"
    b.wrapper :input_group_tag, tag: "div", class: "input-group input-group-flat" do |ba|
      ba.optional :prepend
